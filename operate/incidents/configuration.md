---
description: >-
  Release-backed incident strategy configuration for Elsa 3.8.2 hosts and
  workflow definitions.
---

# Configuration

In `release/3.8.2`, incident strategy resolution happens in this order:
...
injection so Elsa can resolve it and Studio can list it from the descriptors
endpoint:
