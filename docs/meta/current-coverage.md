...
5. **Reference completeness**
   ...
   - The API permission catalog is now reconciled with the current
     `release/3.9.0` resource/verb source. Future release branches may require
     another claim-by-claim refresh.
